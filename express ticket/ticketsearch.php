...
<div style="width:800px; height:330px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">TICKET REPORT</h1></center>
...
<div style=" max-height:200px; max-width:600px; overflow:scroll"> 
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <thead >
                         <tr> <th>Id</th><th>Date</th><th>Names</th><th>time</th><th>Trip</th><th>pirce</th><th>Update</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        $search=$_REQUEST['search'];
$query="select * from ticket where t_id like '%$search%' or date like '%$search%' or tr_names like '%$search%' or time like '%$search%' or destination like '%$search%' or price like '%$search%'";
