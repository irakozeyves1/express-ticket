...
<div style="width:800px; height:280px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">WORKER REGISTER</h1></center><form action="workersend.php" method="post">
<center><table>
<tr><td>First Name:</td><td><input type="text" name="name1"></td></tr>

<tr><td>Last Name:</td><td><input type="text"name="name2"></td></tr>
<tr><td>Address:</td><td><input type="text"name="name3"></td></tr>
...
<tr><td>Telephone:</td><td><input type="text"name="name5"></td></tr>
	
	<tr><td>Salary:</td><td><input type="text"name="name6"></td></tr>
