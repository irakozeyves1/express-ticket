...
<div style="width:800px; height:280px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">CAR REGISTER</h1></center><form action="crsend.php" method="post">
<center><table>
<tr><td>Model:</td><td><input type="text" name="name1"></td></tr>

<tr><td>Plate Number:</td><td><input type="text"name="name2"></td></tr>
