...
<div style="width:800px; height:330px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">CAR REPORT</h1></center>
...
$query="select * from gar where cr_id like '%$search%' or date like '%$search%' or cr_type like '%$search%' or plac like '%$search%'";
