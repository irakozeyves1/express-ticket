...
<div style="width:800px; height:330px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:0; color:#663333;">WORKER REPORT</h1></center>
...
<div style=" max-height:200px; max-width:600px; overflow:scroll">
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <tbody>
                        <?php
                        $query = mysql_query("SELECT * FROM worker") or die(mysql_error());
