...
<div style="background-color:#FF99FF; width:800px; height:140px"><img src="photos/DUSASIRANEHEADER.png"</div>
...
<ul>
<li><a href="memberform.php" >member</a></li>
<li><a href="contributionform.php"  >contribution</a></li>
<li><a href="materaform.php"  >matera</a></li>

<li><a href="userauthform.php"  >user</a></li>
<li><a href="autho_imfoform.php"  >security</a></li>
</ul>
</li></ul>
...
<li><a href="contributionreport.php"  >contribution</a></li>
<li><a href="materareport.php" >matera</a></li>

</ul>
</li></ul>

<ul><li><a href="#">EDITY</a>
<ul>
<li><a href="memberview.php"  >member</a></li>
<li><a href="contributionview.php"  >contribution</a></li>
<li><a href="materaview.php" >matera</a></li>

</ul>
<li><a href="authview.php"  >user</a></li>
...
<div style="width:800px; height:280px; background:#00CCFF; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">TRAVELLER

 FORM</h1></center><form action="travelersend.php" method="post">
<center><table>
<tr><td>Names:</td><td><input type="text" name="name1"></td></tr>

<tr><td>Contact:</td><td><input type="text"name="name2"></td></tr>
...
<div style="width:800px; height:20px; background-color:#999900;"><center><b>Designed and Developed   by MURAGIJIMANA Beathe in 2015 in S6(C.S.M)
</b></center></div>
</body>
</html>
